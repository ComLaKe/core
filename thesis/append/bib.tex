\begin{thebibliography}{69}
  ...
  \bibitem{pin} ``Consensus components''.
  ...
  \bibitem{crdt} Marc Shapiro, Nuno Preguiça, Carlos Baquero and Marek Zawirski.
    ``Conflict-free Replicated Data Types''.
    \emph{Stabilization, Safety, and Security of Distributed Systems,
    \nth{13} International Symposium}, pp.~386--400.
    Springer Berlin Heidelberg, 2011.  \doi{10.1007/978-3-642-24550-3\_29}.
  \bibitem{ipfs} Juan Benet.
    \emph{IPFS - Content Addressed, Versioned, P2P File System}.
    Computing Research Repository, 2014.  \arxiv{1407.3561}.
  ...
  \bibitem{aleph} Peter Taoussanis.
