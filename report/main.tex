...
with Append-Only Storages and Query Polymorphism}
...
which is evaluated to either true or false}}
...
{\selectlanguage{vietnamese}\let\clearpage\relax\chapter*{Lời Cam Đoan}
\vspace{-4em}Tôi xin cam đoan rằng tôi đã soạn toàn bộ luận án này, hoàn toàn
từ kết quả công việc của chính bản thân tôi, trừ khi được chỉ rõ qua trích dẫn.
Công việc được trình bày chưa bao giờ được nộp cho việc cấp học vị
hay chứng chỉ trình độ chuyên môn nào trước đây.}
